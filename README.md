...
- 💻 Full-Stack Developer | Network & Database Engineer | UI/UX Designer  
- ⚡️ Currently exploring React.js, Node.js, Python, Kotlin & Networking  
- 🚀 Passionate about open-source, impactful tech projects, and building real-world solutions  
- 📚 Lifelong learner: improving every day ✨  

---

## 💼 Experience
- Frontend Developer Intern – Nile Technologies  
- Full-Stack Developer Intern – Mizan Institutional Technology  
- Built functional UI/UX designs and real-world apps  
...
- 🐙 GitHub: [@ameturebi](https://github.com/ameturebi)  
- 💬 Telegram: [@ameturebi](https://t.me/ameturebi)  
- 🔗 LinkedIn: [Ekram Shemsu](https://www.linkedin.com/in/ekram-shemsu-issa/)  
